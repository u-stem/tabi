...
export const Fab = forwardRef<HTMLButtonElement, FabProps>(
  ({ label, hidden, className, children, onClick, ...props }, ref) => {
    ...
    return (
      <button
        ...
        aria-label={label}
        className={cn(
          "fixed right-4 z-30 flex h-14 w-14 items-center justify-center rounded-full bg-primary text-primary-foreground shadow-lg transition-[transform,opacity,box-shadow] duration-300 hover:scale-110 hover:shadow-xl lg:active:scale-95",
          !isMobile && "hidden",
