    ...
    >
      {tabs.map((tab, index) => (
        <button
          ...
          className={cn(
            "min-w-0 rounded-md px-2 py-1.5 text-sm font-medium min-h-[36px] active:scale-[0.97] overflow-hidden transition-[colors,box-shadow] duration-200",
            activeTab === tab.id
