  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        range_middle:
          "bg-primary/10 [&>button]:bg-transparent [&>button]:!text-black dark:[&>button]:!text-white [&>button]:hover:!bg-black [&>button]:hover:!text-white dark:[&>button]:hover:!bg-white dark:[&>button]:hover:!text-black",
        hidden: "invisible",
        ...classNames,
      }}
      components={{
