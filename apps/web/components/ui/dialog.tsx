...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn("select-none text-lg font-semibold leading-none tracking-tight", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Description
    ref={ref}
    className={cn("select-none text-sm text-muted-foreground", className)}
    {...props}
  />
));
