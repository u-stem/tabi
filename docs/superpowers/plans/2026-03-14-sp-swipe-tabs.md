...
- [ ] **Step 2: swipe 関連の state と hook を削除**
...
- [ ] **Step 4: デスクトップレイアウトの ARIA 参照を確認**
...
- [ ] **Step 1: sp-bottom-nav.tsx の active:scale を削除**
...
- [ ] **Step 2: settings ページの SP版タブの active:scale を削除**
